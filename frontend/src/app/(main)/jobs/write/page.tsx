    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            {CATEGORIES.map((cat) => (
              <label key={cat.value} className="cursor-pointer">
                ...
                <span className="block rounded-lg border border-gray-200 px-2 py-2 text-center text-xs peer-checked:border-indigo-700 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 peer-checked:font-semibold transition-colors">
                  {cat.label}
                </span>
              </label>
            ))}
          ...
          <div className="space-y-2">
            ...
            {imageUrls.length < MAX_IMAGES && (
              <button
                ...
                className="flex items-center gap-2 rounded-xl border-2 border-dashed border-gray-200 px-4 py-3 text-sm text-gray-500 hover:border-indigo-300 hover:text-indigo-600 transition-colors disabled:opacity-50"
              >
        ...
        <button
          ...
          className="w-full rounded-xl bg-indigo-700 py-4 text-base font-semibold text-white hover:bg-indigo-800 transition-colors disabled:opacity-60"
        >
